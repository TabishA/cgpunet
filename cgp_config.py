...
# Evaluation of CNNs
def cnn_eval(dag, gpu_id, epoch_num, batchsize, batchsize_valid, dataset_path, img_format, mask_format, input_shape,
             target_shape, out_model, verbose, return_dict):
    ...
    train = cnn.CNN_train(dataset_path, img_format, mask_format, verbose=verbose, input_shape=input_shape,
                          target_shape=target_shape, batchsize=batchsize, batchsize_valid=batchsize_valid)
    try:
        evaluation = train(dag, gpu_id, epoch_num=epoch_num, out_model=out_model)
    except Exception as e:
        print(e)
        evaluation = (0, 0)
    print('\tgpu_id:', gpu_id, 'model_name: ', out_model.split('/')[2], ', eval:', evaluation)
    return_dict[out_model] = evaluation


class CNNEvaluation(object):
    def __init__(self, gpu_num, dataset_path, img_format, mask_format, verbose=True, epoch_num=50, batchsize=16,
                 batchsize_valid=16, input_shape=(256, 256, 1), target_shape=(256, 256, 1)):
    ...
    def __call__(self, DAG_list, epochs, model_names, retrain=False):
        ...
        for i in np.arange(0, len(DAG_list), self.gpu_num):
            ...
            for j in range(process_num):
                ...
                arguments = (DAG_list[i + j], j, epochs[i + j], self.batchsize, self.batchsize_valid, self.dataset_path,
                             self.img_format, self.mask_format, self.input_shape, self.target_shape, out_model,
                             self.verbose, return_dict)
...
class CgpInfoConvSet(object):
    def __init__(self, rows=30, cols=40, level_back=40, min_active_num=8, max_active_num=50):
        ...
        self.func_type = ['S_ConvBlock_1_1', 'S_ConvBlock_2_1', 'S_ConvBlock_4_1', 'S_ConvBlock_8_1',
                          'S_ConvBlock_16_1', 'S_ConvBlock_32_1', 'S_ConvBlock_1_3', 'S_ConvBlock_2_3',
                          'S_ConvBlock_4_3', 'S_ConvBlock_8_3', 'S_ConvBlock_16_3', 'S_ConvBlock_32_3',
                          'S_ConvBlock_1_5', 'S_ConvBlock_2_5', 'S_ConvBlock_4_5', 'S_ConvBlock_8_5',
                          'S_ConvBlock_16_5', 'S_ConvBlock_32_5',
                          ...
                          'D_DeconvBlock_1_1', 'D_DeconvBlock_2_1', 'D_DeconvBlock_4_1', 'D_DeconvBlock_8_1',
                          'D_DeconvBlock_16_1', 'D_DeconvBlock_32_1', 'D_DeconvBlock_1_3', 'D_DeconvBlock_2_3',
                          'D_DeconvBlock_4_3', 'D_DeconvBlock_8_3', 'D_DeconvBlock_16_3', 'D_DeconvBlock_32_3',
                          'D_DeconvBlock_1_5', 'D_DeconvBlock_2_5', 'D_DeconvBlock_4_5', 'D_DeconvBlock_8_5',
                          'D_DeconvBlock_16_5', 'D_DeconvBlock_32_5',
                          ...
                          'Concat', 'Sum', 'Concat', 'Sum', 'Concat', 'Sum', 'Concat', 'Sum', 'Concat', 'Sum', 'Concat',
                          'Sum', 'Concat', 'Sum', 'Concat', 'Sum',
                          'Max_Pool', 'Avg_Pool', 'Max_Pool', 'Avg_Pool', 'Max_Pool', 'Avg_Pool', 'Max_Pool',
                          'Avg_Pool', 'Max_Pool', 'Avg_Pool', 'Max_Pool', 'Avg_Pool', 'Max_Pool', 'Avg_Pool',
                          'Max_Pool', 'Avg_Pool']
